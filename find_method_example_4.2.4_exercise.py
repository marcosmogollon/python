...
def string_finder(target_string, search_string):
    ...
    target_string_index = target_string.find(search_string)
    one_minus_other =  int(target_string_length - search_string_length)
    if target_string_index >= 0:
        if target_string_index == 0:
            return "Beginning"
        elif target_string_length - search_string_length == target_string_index:
            return "End"
        else:
            return "Middle"
    else:
